...
appmain = [['a1', 'UCO',            ['lambda: tidcmds.setcmd("UCO")']],
           ...
           ['c2', 'TFL',            ['lambda: tidcmds.setcmd("TFL")',
                                     'lambda: appmain.close()',
...
apptfl = [['a1', '130',          ['lambda: tidcmds.setarg("130", 1)']],
          ['a2', '200',          ['lambda: tidcmds.setarg("200", 1)']],
          ['a3', '250',          ['lambda: tidcmds.setarg("250", 1)']],
          ['a4', '',             None],

          ['b1', '180',          ['lambda: tidcmds.setarg("180", 1)']],
          ['b2', '240',          ['lambda: tidcmds.setarg("240", 1)']],
          ['b3', 'RCL\nVALUE',   ['lambda: None']],
          ['b4', '',             None],
