...
# Read waypoint data
wptdata = pd.read_excel(r"C:\Users\LVNL_ILAB3\PycharmProjects\bluesky\scenario\T-bar\Waypoints.xlsx")
...
# fwpts = open(r"C:\Users\LVNL_ILAB3\PycharmProjects\bluesky\scenario\T-bar\waypoints.scn", "w")
# fwpts.write("# Create waypoints\n")
# for i in range(len(wptdata)):
#     fwpts.write("00:00:00.00>DEFWPT "+wptdata['Name'].iloc[i]+" " +
#                 str(wptdata['Lat'].iloc[i])+" "+str(wptdata['Lon'].iloc[i])+"\n")
# fwpts.close()
